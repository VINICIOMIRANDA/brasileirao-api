package br.com.webscrapjava.brasileiraoapi.controller;
...
import br.com.webscrapjava.brasileiraoapi.dto.PartidaDTO;
import br.com.webscrapjava.brasileiraoapi.dto.PartidaResponseDTO;
import br.com.webscrapjava.brasileiraoapi.entity.Equipe;
import br.com.webscrapjava.brasileiraoapi.entity.Partida;
import br.com.webscrapjava.brasileiraoapi.exception.StandardError;
import br.com.webscrapjava.brasileiraoapi.service.PartidaService;
...
public class PartidaController {
	...
	@ApiResponses(value = {
			@ApiResponse(code = 201, message = "OK", response = Partida.class),
			@ApiResponse(code = 400, message = "Bad request", response = StandardError.class),
			@ApiResponse(code = 401, message = "Unauthorized", response = StandardError.class),
			@ApiResponse(code = 403, message = "Forbidden", response = StandardError.class),
			@ApiResponse(code = 404, message = "Not Found", response = StandardError.class),
